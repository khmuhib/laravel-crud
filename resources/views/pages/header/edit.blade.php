                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form action="{{ url('admin/header/update/' . $header->id) }}" enctype="multipart/form-data"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <img src="{{ asset('uploads/header/img/' . $header->bg_image) }}" alt=""
